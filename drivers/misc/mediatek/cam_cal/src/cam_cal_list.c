...
#include "common/GT24c64a/GT24c64a.h"
...
stCAM_CAL_FUNC_STRUCT g_camCalCMDFunc[] = {
	...
	{CMD_GT24C64A, gt24c32a_selective_read_region},
...
stCAM_CAL_LIST_STRUCT g_camCalList[] = {
	...
	{0xd853, 0xA0, CMD_GT24C64A, cam_cal_check_mtk_cid},

	//{IMX214_MONO_SENSOR_ID, 0xA0, CMD_AUTO, cam_cal_check_mtk_cid},
	{0xd850, 0xA0, CMD_AUTO, cam_cal_check_double_eeprom},
