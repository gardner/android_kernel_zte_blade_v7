...
//#define OTP_SIZE 1913
//char data[4096]= {0};
//char OTPData[OTP_SIZE]= {0};
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .hs_video = {
        ...
        .framelength = 1664, //674,
        .startx = 0,
        .starty = 0,
        .grabwindow_width = 2112,  //640
        .grabwindow_height = 1568,  //480
        .mipi_data_lp2hs_settle_dc = 100,//unit , ns
        .max_framerate = 600, 
    },
    .slim_video = {
...
// { 4256, 3152, 0, 376, 4256, 2392, 1064, 598, 8, 2, 1056, 594, 208, 56, 640, 480}, //hight speed video 
 { 4256, 3152, 0, 4, 4256, 3144, 2128, 1572, 3, 2, 2112, 1568, 0, 0, 2112, 1568},// hight speed video  video    
...
static void hs_video_setting(void)
{
	...
	write_cmos_sensor(0x0301, 0x00); //
                     write_cmos_sensor(0x0302, 0x32); //                                                           
                     write_cmos_sensor(0x0303, 0x01); // 00                                                       
                     write_cmos_sensor(0x3501, 0xc0); //                                                           
	write_cmos_sensor(0x3612, 0x27); // 
                     write_cmos_sensor(0x370a, 0x67); // 24                                                          
                     write_cmos_sensor(0x3729, 0x11); // 00                                                          
                     write_cmos_sensor(0x372a, 0x00); // 04                                                          
	write_cmos_sensor(0x3718, 0x10); //  
                     write_cmos_sensor(0x372f, 0x90); // a0                                                          
                     write_cmos_sensor(0x3801, 0x00); // 0c                                                          
                     write_cmos_sensor(0x3802, 0x00); //                                                           
                     write_cmos_sensor(0x3803, 0x0a); // 00                                                          
                     write_cmos_sensor(0x3805, 0x9f); // 93                                                          
                     write_cmos_sensor(0x3806, 0x0c); //                                                           
                     write_cmos_sensor(0x3807, 0x53); // 4f                                                          
                     write_cmos_sensor(0x3808, 0x08); // 10                                                          
                     write_cmos_sensor(0x3809, 0x40); // 80                                                          
                     write_cmos_sensor(0x380a, 0x06); // 0c                                                          
                     write_cmos_sensor(0x380b, 0x20); // 40                                                          
                     write_cmos_sensor(0x380c, 0x09); //                                                         
                     write_cmos_sensor(0x380d, 0x60); //                                                         
                     ...
                     write_cmos_sensor(0x3810, 0x00); //                                                           
                     write_cmos_sensor(0x3811, 0x04); //                                                           
                     write_cmos_sensor(0x3813, 0x02); // 08                                                          
                     write_cmos_sensor(0x3814, 0x31); // 11                                                          
                     write_cmos_sensor(0x3815, 0x31); // 11                                                          
	write_cmos_sensor(0x3820, 0x00); //
                     write_cmos_sensor(0x3821, 0x06); // 04                                                          
                     write_cmos_sensor(0x3836, 0x08); // 04                                                          
                     write_cmos_sensor(0x3837, 0x02); // 01                                                          
                     write_cmos_sensor(0x4020, 0x00); // 02                                                          
                     write_cmos_sensor(0x4021, 0xe4); // 4c                                                          
                     write_cmos_sensor(0x4022, 0x04); // 0e                                                          
                     write_cmos_sensor(0x4023, 0xd7); // 37                                                          
                     write_cmos_sensor(0x4024, 0x05); // 0f                                                          
                     write_cmos_sensor(0x4025, 0xbc); // 1c                                                          
                     write_cmos_sensor(0x4026, 0x05); // 0f                                                          
                     write_cmos_sensor(0x4027, 0xbf); // 1f                                                          
                     write_cmos_sensor(0x4501, 0x78); // 38                                                          
	write_cmos_sensor(0x4601, 0x04); //
	write_cmos_sensor(0x4603, 0x00); //
                     write_cmos_sensor(0x4837, 0x0d); //                                                        
                     write_cmos_sensor(0x5401, 0x61); // 71                                                          
                     write_cmos_sensor(0x5405, 0x40); // 80                                                          
                     write_cmos_sensor(0x5b21, 0x37); // 91                                                          
                     write_cmos_sensor(0x5b22, 0x0c); // 02                                                          
                     write_cmos_sensor(0x5b23, 0x37); // 91                                                          
                     write_cmos_sensor(0x0100, 0x01); ////  
            ...
            *sensor_id = return_sensor_id();
            ...
            if (*sensor_id == imgsensor_info.sensor_id) {
	         ...
	         mtk_sensorinfo_set_back_sensor_id(OV13853_SENSOR_ID);
                //read_eeprom(0x0000, OTPData, size);
                //read_otp();
                return ERROR_NONE;
            }
