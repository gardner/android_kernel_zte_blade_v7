...
#define key_1           220,2045
#define key_2           540,2045
#define key_3           860,2045
//#define key_4           {420, 850}

#define TPD_KEYS        {158,172,139/*KEY_BACK, KEY_HOME, KEY_MENU, KEY_SEARCH*/}
#define TPD_KEYS_DIM    { {key_1,200,165}, {key_2,200,165}, {key_3,200,165}/*, {key_4, 50, 30} */}
#if 0
//add by wkh begin
...
#define GTP_DBL_CLK_WAKEUP    1//0	/* double-click wakup, function together with GTP_SLIDE_WAKEUP*/
...
#define GTP_KEY_TAB	 {KEY_BACK, KEY_HOME, KEY_MENU/*, KEY_SEND*/}
#endif
...
#define GT91XX_INFO_PROC_FILE     "gt9xx_info"//add by wkh
